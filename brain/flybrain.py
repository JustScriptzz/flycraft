...
class FlyBrain:
    def __init__(self, seed=7, eps0=0.35, eps_floor=0.05, eps_decay=0.985,
        ...
        self.W_ma = np.array([
            [0.1, 0.9, 0.0, 0.2, 0.2, 0.3, 0.3, 0.3, 1.0],   # approach
            [0.1, 0.0, 0.8, 0.4, 0.4, 0.2, 0.6, 0.6, 0.0],   # avoid
            [0.0, 0.3, 0.0, 0.0, 0.0, 0.9, 0.1, 0.1, 0.2],   # vigor
        ])
    ...
    # -- main step ----------------------------------------------------
    def tick(self, sectors, proprio, reward, done):
