...
/**
 * Top-right HUD panel for 1.20.1: live firing rates + stats.
 * (This yarn build backports DrawContext naming, so the body matches 1.21.4;
 * only the entry signature differs — MatrixStack comes from the event.)
 */
public class BrainOverlay {
    ...
    public static void render(DrawContext ctx, float tickDelta) {
        ...
        ctx.getMatrices().translate(sw - 172 * SCALE - 6, 6, 0);
